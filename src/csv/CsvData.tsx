...
export class CsvColumn {
    ...
    private sortingHelperCached: CsvValueTypeSorting<CsvValueType> | undefined = undefined;
    /**
    ...
    get sortingHelper(): CsvValueTypeSorting<CsvValueType> {
    ...
    private computeMaxCharWidth(maxCharWidth: undefined | number | { compute: CsvValueSealed[] }): number {
        if (typeof maxCharWidth === "undefined") {
            return this.maxCharWidth;
        } else if (typeof maxCharWidth === "number") {
            return maxCharWidth;
        } else if (typeof maxCharWidth === "object") {
            if (maxCharWidth.compute.length === 0) {
                return this.maxCharWidth;
            }
            let newWidth = 1;
            for (const value of maxCharWidth.compute) {
                const w = this.widthOfValue(value);
...
export class CsvData {
    ...
    withColumn(colIndex: number, col: CsvColumn): CsvData {
